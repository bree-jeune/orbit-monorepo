 ...
 * Get all items from storage
   * @returns {Promise<import('@orbit/core').OrbitItem[]>}
 */
 ...
 * @param {import('@orbit/core').OrbitItem[]} items
...
/**
 * Add a single item
 * @param {import('@orbit/core').OrbitItem} item
 * @returns {Promise<void>}
 */
 ...
 * @param {string} id
 * @param {import('@orbit/core').OrbitItem} updated
 * @returns {Promise<void>}
 */
